// "Ask Mathesis" — inline conversational panel below the globe.
...
import { byId, MATHEMATICIANS } from './data.js'
import {
  Anthropic,
  MODELS,
  getApiKey,
...
const ROSTER = [...MATHEMATICIANS].sort((a, b) => a.name.localeCompare(b.name))
...
export default function AgentPanel({ personaId, onExitPersona, selectedId, onSelect }) {
  ...
  return (
    <section className="agent" aria-label="Ask Mathesis">
